...
<?php
		session_start();
		$currentpage="transHash";
		include "pages.php";
?>
<html>
	<head>
		<title>transHash</title>
...
<fieldset>
	<legend>transHash:</legend>
    <p>
        <label for="hash">transHash</label>
...
// query to select all information from supplier table
	...
	if($hash==NULL){
		$hash = 0;
		$query = "SELECT * FROM TransTable where 1";

	}else{
		$hash="\"$hash\"";
		$query = "SELECT * FROM TransTable where transHash=$hash";
